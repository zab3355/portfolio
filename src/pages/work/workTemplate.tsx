      ...
      {!isMobile ? (
        <Box>
          ...
          <Section>
            ...
            {images[3] ? (
              <ImageContainer>
                <img src={images[3]} onClick={() => expandImage(images[3])} alt={`${title} ${images[1]}`} style={{ width: '100%', height: 'auto' }} />
              </ImageContainer>
            ) : (null)}
          </Section>
          <Section>
          ...
          {images[5] ? (
            <ImageContainer>
              <img src={images[5]} onClick={() => expandImage(images[5])} alt={`${title} ${images[1]}`} style={{ width: '100%', height: 'auto' }} />
            </ImageContainer>
          ) : (null)}
        ...
        <Box>
          ...
          <SectionMobile>
            <TextContainer>
              ...
              {images[3] !== null ? (
                <ImageContainer>
                  <img src={images[3]} onClick={() => expandImage(images[2])} alt={`${title} ${images[3]}`} style={{ width: '100%', height: 'auto' }} />
                </ImageContainer>
              ) : null}
            </TextContainer>
          </SectionMobile>
          <SectionMobile>
            <TextContainer>
              ...
              {images[4] !== null ? (
                <ImageContainer>
                  <img src={images[4]} onClick={() => expandImage(images[4])} alt={`${title} ${images[4]}`} style={{ width: '100%', height: 'auto' }} />
                </ImageContainer>
              ) : null}
            </TextContainer>
          </SectionMobile>
